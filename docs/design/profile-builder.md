...
Supersedes: PR #31781 (prompt_toolkit `max profile wizard`)

## Why this, not the CLI wizard

PR #31781 added a keyboard-driven `max profile wizard` in the terminal.
...
5. spawn `max -p <profile> skills install <id>` per hub skill (async, returns PIDs)
