...
Reporta de forma privada a través de [GitHub Security Advisories](https://github.com/StardustResearch/max-agent/security/advisories/new)
...
- **Configuraciones documentadas de emergencia.** Compensaciones seleccionadas por el operador
  ...
  la seguridad de max-home, y similares. Los informes contra esas
