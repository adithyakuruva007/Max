...
DEFAULT_DATASETS = [
    "StardustResearch/swe-terminus-agent-glm-kimi-minimax",
    "StardustResearch/max-agent-megascience-sft1",
    "StardustResearch/Max-Agent-Thinking-GLM-4.7-SFT2",
    "StardustResearch/Max-Agent-Thinking-GLM-4.7-SFT1",
    "StardustResearch/terminal-tasks-glm-max-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "StardustResearch/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload StardustResearch/{output_name} {final_output}")
