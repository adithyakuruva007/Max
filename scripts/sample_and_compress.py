...
DEFAULT_DATASETS = [
    ...
    "NousResearch/max-agent-megascience-sft1",
    "NousResearch/Max-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Max-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-max-agent"
]
