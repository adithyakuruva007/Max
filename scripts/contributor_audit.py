...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Max\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@stardustresearch.com",
    "cursoragent@cursor.com",
    "hermes@stardustresearch.com",
    "max-audit@example.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "StardustResearch/max-agent",
                "--state", "merged",
