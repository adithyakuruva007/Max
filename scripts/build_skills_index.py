#!/usr/bin/env python3
"""Build the Max Skills Index — a centralized JSON catalog of all skills.
...
`max skills search/install` can use it without hitting the GitHub API.
...
# Ensure MAX_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Max Skills Index...", flush=True)
