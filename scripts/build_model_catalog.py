#!/usr/bin/env python3
"""Build the Max Model Catalog — a centralized JSON manifest of curated models.
...
Max CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Max release.
...
# Ensure MAX_HOME is set for imports that touch it at module level.
os.environ.setdefault("MAX_HOME", os.path.join(os.path.expanduser("~"), ".max"))

from max_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "max-agent repo",
            "docs": "https://max-agent.stardustresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Max '
