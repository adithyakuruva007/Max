...
AUTHOR_MAP = {
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows max-shim resolution + prefer --update on recovery; #52378)
    ...
    "hermes@stardustresearch.com": "StardustResearch",
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: max-eval community link)
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"max-agent[acp]=={semver}"
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/StardustResearch/max-agent",
