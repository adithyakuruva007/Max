...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Max session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Max session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Max agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Max Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Max gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Max session in it",
