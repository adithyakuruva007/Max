...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$MAX_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_max_dir("platforms/whatsapp/session", "whatsapp/session")
