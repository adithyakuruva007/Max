...
def _max_version() -> str:
    """Return the max-agent version string, or "dev" if it can't be resolved.

    Tries the installed package metadata first (authoritative for a pip/uv
    install), then the in-tree ``max_cli.__version__`` (covers editable /
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    def _create_agent(
        ...
        gateway platforms), falling back to the max-api-server default.
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response(
            {"status": "ok", "platform": "max-agent", "version": _max_version()}
        )
    ...
    async def _handle_capabilities(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({
            ...
            "object_hermes": "hermes.api_server.capabilities",
            "platform": "max-agent",
    ...
    async def _handle_create_session(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"object": "max.session", "object_hermes": "hermes.session", "session": self._session_response(session)}, status=201)
    ...
    async def _handle_get_session(self, request: "web.Request") -> "web.Response":
        ...
        if err:
            return err
        return web.json_response({"object": "max.session", "object_hermes": "hermes.session", "session": self._session_response(session)})
    ...
    async def _handle_delete_session(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"object": "max.session.deleted", "object_hermes": "hermes.session.deleted", "id": session_id, "deleted": bool(deleted)})
    ...
    async def _handle_fork_session(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"object": "max.session", "object_hermes": "hermes.session", "session": self._session_response(fork)}, status=201)
    ...
    async def _handle_session_chat(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response(
            {
                "object": "max.session.chat.completion",
                "object_hermes": "hermes.session.chat.completion",
    ...
    async def _handle_responses(self, request: "web.Request") -> "web.Response":
        ...
        response_headers = {"X-Max-Session-Id": session_id}
        if gateway_session_key:
            response_headers["X-Max-Session-Key"] = gateway_session_key
        return web.json_response(response_data, headers=response_headers)
    ...
    async def _handle_run_approval(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({
            "object": "max.run.approval_response",
            "object_hermes": "hermes.run.approval_response",
            "run_id": run_id,
            "choice": choice,
            "resolved": resolved,
        })
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            # that is the exact surface the max-0day campaign abused to write
