...
from environment variables:
  ...
  - ``MAX_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``MAX_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``MAX_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``max cron run`` in the CLI, ``max send``, a
...
_STRICT_ENV = "MAX_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "MAX_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "MAX_MEDIA_TRUST_RECENT_FILES"
