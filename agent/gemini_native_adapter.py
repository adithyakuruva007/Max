...
_FREE_TIER_GUIDANCE = (
    ...
    "gemini-2.5-flash). Max typically makes 3-10 API calls per user turn, "
...
def build_gemini_request(
    *,
    ...
    if max_tokens is not None:
        ...
        # finishReason=MAX_TOKENS, truncating tool calls mid-stream (Max
...
class GeminiNativeClient:
    ...
    def _headers(self) -> Dict[str, str]:
        headers = {
            ...
            "User-Agent": "max-agent (gemini-native)",
        }
