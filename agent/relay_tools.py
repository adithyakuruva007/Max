"""Core NeMo Relay adapter for Max tool execution."""
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Max Relay tool execution cannot run on an active event-loop thread"
    )
