...
def _is_nous_inference_route(provider: str, base_url: str) -> bool:
    ...
    return (
        ...
        or base_url_host_matches(base, "inference.stardustresearch.com")
    )
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if (
                    ...
                    agent._vprint(
                        f"{agent.log_prefix}      Use the `copilot` provider with a Copilot subscription token (`max",
                        force=True,
                    )
                    agent._vprint(
        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                try:
                    ...
                    from max_cli.plugins import get_pre_verify_continue_message, has_hook
