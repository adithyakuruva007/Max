...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    is_nous_portal = "stardustresearch" in eff_base_url.lower()
...
def create_openai_client(agent, client_kwargs: dict, *, reason: str, shared: bool) -> Any:
    ...
    # Delegate all rate-limit / 5xx retry to max's outer conversation loop,
...
def sanitize_api_messages(messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    #
    # We do NOT drop the call: max' own dispatch loop intentionally keeps an
