...
def _install_npm(
    ...
    """
    # Managed npm first: $MAX_HOME/node is not on an arbitrary process's
    # PATH, so a bare which() misses the Node that Max installed and
    ...
    if npm is None:
        ...
        return None
    staging = hermes_lsp_bin_dir().parent  # <MAX_HOME>/lsp/
