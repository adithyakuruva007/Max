...
_SESSION_CWD: ContextVar = ContextVar("MAX_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Max
    # source tree itself, which is a legitimate workspace when the user is
    # developing Max (per-surface policy for fallback-picked directories
