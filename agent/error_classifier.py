...
# ``data:`` field before Max receives a completion chunk.  Keeping this
...
# See: https://github.com/NousResearch/max-agent/issues/69078
...
#
# See: https://github.com/NousResearch/max-agent/issues/27344
...
# case: a stream dies mid-response and Max persists a content-less
...
# Request parameters that Max sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # max_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from max_cli.plugins import get_plugin_error_classification
