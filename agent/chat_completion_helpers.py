    ...
    if _ttfb_timeout <= 0:
        ...
        if (
            ...
            logger.info(
                ...
                "Set MAX_CODEX_TTFB_STRICT=1 to force early reconnects.",
...
def build_api_kwargs(agent, api_messages: list) -> dict:
    ...
    if _is_qwen:
        _qwen_meta = {
            "sessionId": agent.session_id or "max",
...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        if not fb_api_key_hint:
            ...
            # _normalize_custom_provider_entry in max_cli/config.py).
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    # the user explicitly set MAX_STREAM_STALE_TIMEOUT.
