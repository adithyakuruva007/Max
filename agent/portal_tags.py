...
Tag shape (sent in OpenAI-compatible ``extra_body['tags']``):
    ...
    [
        "product=max-agent",
        "client=max-client-v<__version__>",
    ]
...
def max_client_tag() -> str:
    ...
    Format: ``client=max-client-v<MAJOR>.<MINOR>.<PATCH>``.
    """
    return f"client=max-client-v{_max_version()}"
...
def nous_portal_tags() -> List[str]:
    ...
    """
    return ["product=max-agent", max_client_tag()]
