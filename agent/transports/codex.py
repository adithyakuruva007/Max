...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Max's web-provider config and
        ...
        # native search engine for xAI sessions instead of Max's
        # configured web provider (Tavily/etc.), and those results bypass
        # Max's tool-trace / citation plumbing (they arrive baked into the
