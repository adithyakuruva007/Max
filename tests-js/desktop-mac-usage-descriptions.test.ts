 ...
 *
 * Each entry is a key/value pair that lands in the packaged Max.app's
 ...
 * "Max wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Max wants to access Music" when Max never touches the Music
