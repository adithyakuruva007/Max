...
Keeps the ACP server tests offline: ``MaxACPAgent._build_model_state``
calls ``max_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import max_cli.inventory as inventory
