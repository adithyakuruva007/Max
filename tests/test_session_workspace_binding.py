"""Session <-> workspace grouping key (max_state.workspace_key).

The key is what `max sessions list --workspace` groups/filters on. It is a
...
from max_state import workspace_key
