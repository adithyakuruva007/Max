"""Regression test: max update must not load cryptography eagerly."""
...
assert 'max_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running max update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so max_cli is importable,
...
import max_cli.main
from max_cli.update_cmd import _cmd_update_check
