...
from max_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/max_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("max_cli.lifecycle.invoke_hook")
@patch("max_cli.lifecycle.finalize_session")
