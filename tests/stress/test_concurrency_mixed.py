...
def worker_loop(worker_id: int, max_home: str, result_file: str) -> None:
...
def reclaimer_loop(max_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="max_mixed_stress_")
    print(f"MAX_HOME = {home}")
