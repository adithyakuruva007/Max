...
Run: pytest tests/max_cli/test_dashboard_auth_native_flow.py
"""
...
from max_cli.dashboard_auth.base import Session
...
@pytest.fixture
def pw_gated_client():
    from max_cli.dashboard_auth.routes import _reset_password_rate_limit
    from tests.max_cli.test_dashboard_auth_password_login import (
        PasswordProvider,
    )
