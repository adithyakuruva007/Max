...
class TestHappyPath:
    ...
    def test_non_default_portal_is_persisted(self, capsys):
        ...
        assert (
            saved["MAX_DASHBOARD_PORTAL_URL"]
...
class TestCustomPortalPersistence:
    ...
    def test_explicit_custom_url_updates_existing_in_place(self, capsys):
        ...
        assert (
            saved["MAX_DASHBOARD_PORTAL_URL"] == "https://new-preview.example.com"
        )
    ...
    def test_explicit_custom_url_persisted_even_when_equals_default(self, capsys):
        ...
        saved = self._run(
            args=_ns(portal_url="https://portal.stardustresearch.com"),
            portal="https://portal.stardustresearch.com",
            existing_portal=None,
        )
        assert (
            saved["MAX_DASHBOARD_PORTAL_URL"] == "https://portal.stardustresearch.com"
        )
...
class TestPublicUrlPersistence:
    ...
    def test_origin_derived_from_full_callback_path(self, capsys):
        ...
        assert "/auth/callback" not in saved["MAX_DASHBOARD_PUBLIC_URL"]
    ...
    def test_origin_preserves_port(self, capsys):
        ...
        assert saved["MAX_DASHBOARD_PUBLIC_URL"] == "https://hermes.example.com:8443"
    ...
    def test_public_url_updates_existing_in_place(self, capsys):
        ...
        assert saved["MAX_DASHBOARD_PUBLIC_URL"] == "https://new.example.com"
