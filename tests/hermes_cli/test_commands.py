...
class TestSlackNativeSlashes:
    ...
    def test_max_catchall_is_first(self):
    ...
    def test_telegram_parity(self):
        ...
        via_max_norm = {_norm(n) for n in _SLACK_VIA_MAX_ONLY}
        missing = (tg_norm - slack_norm) - reserved_norm - via_max_norm
        assert not missing, (
...
class TestSubcommandCompletion:
    ...
    def test_tools_enable_completes_toolset_names(self, monkeypatch):
        ...
        from max_cli import commands as commands_mod
