...
def _restore_tool_modules():
    original_hermes_home = os.environ.get("MAX_HOME")
    original_modules = {
        name: module
    ...
    try:
        ...
        if original_hermes_home is None:
            ...
            os.environ["MAX_HOME"] = original_hermes_home
...
def _install_modal_test_modules(
    ...
    *,
    ...
    os.environ["MAX_HOME"] = str(hermes_home)
    sys.modules["max_cli.config"] = types.SimpleNamespace(
        get_max_home=lambda: hermes_home,
    )
