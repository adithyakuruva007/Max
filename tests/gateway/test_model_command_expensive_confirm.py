...
def _fake_warning():
    return SimpleNamespace(
        message=(
            ...
            "openai/gpt-5.5-pro has known pricing above Max' safety threshold.\n"
...
def _setup_isolated_home(tmp_path, monkeypatch, *, warn):
    ...
    monkeypatch.setattr("max_constants.get_max_home", lambda: max_home)
    monkeypatch.setattr("max_cli.config.get_max_home", lambda: max_home)
    monkeypatch.setattr(
