"""Tests for _setup_feishu() in max_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("max_cli.config.save_env_value", side_effect=mock_save), \
         patch("max_cli.config.get_env_value", side_effect=mock_get), \
         patch("max_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("max_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("max_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("max_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("max_cli.cli_output.print_header"), \
         patch("max_cli.cli_output.print_info"), \
         patch("max_cli.cli_output.print_success"), \
         patch("max_cli.cli_output.print_warning"), \
         patch("max_cli.cli_output.print_error"), \
