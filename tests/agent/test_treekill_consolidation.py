...
* ``max_cli._subprocess_compat.kill_process_tree(proc)`` — also consumed
...
def test_e2e_setsid_grandchild_killed_via_compat_wrapper(tmp_path):
    ...
    from max_cli._subprocess_compat import kill_process_tree
