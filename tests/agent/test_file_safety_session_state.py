...
manipulation. Max keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point MAX_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_max_home /
    ...
    MAX_HOME=<root>/profiles/<name> makes get_default_hermes_root()
