...
See: https://github.com/NousResearch/max-agent/issues/25114
See: https://github.com/NousResearch/max-agent/issues/36144
See: https://github.com/NousResearch/max-agent/issues/29015
"""
...
class TestGetSubprocessHome:
    ...
    def test_host_auto_keeps_real_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        hermes_home = real_home / ".max" / "profiles" / "coder"
