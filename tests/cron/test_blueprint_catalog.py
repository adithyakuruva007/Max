...
the shared /blueprint command handler (max_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated MAX_HOME for anything that touches the
cron job store.
"""
...
class TestCommandHandler:
    ...
    def test_name_match_is_forgiving(self, isolated_home):
        from max_cli.blueprint_cmd import handle_blueprint_command, match_blueprint
