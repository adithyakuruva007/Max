...
class TestRunJobSessionPersistence:
    def test_run_job_passes_session_db_and_cron_platform(self, tmp_path):
        ...
        with patch("cron.scheduler._hermes_home", tmp_path), \
             ...
             patch("max_cli.env_loader.load_hermes_dotenv"), \
    ...
    def test_run_job_heartbeats_oneshot_claim_in_both_wait_modes(
        ...
        monkeypatch.setenv("MAX_CRON_TIMEOUT", timeout_value)
    ...
    def test_run_job_resets_secret_source_cache_before_reload(self, tmp_path, monkeypatch):
        ...
        with patch("cron.scheduler._hermes_home", tmp_path), \
             ...
             patch("max_cli.env_loader.load_hermes_dotenv", _record_load), \
             patch("max_state.SessionDB", return_value=fake_db), \
             patch(
                 "max_cli.runtime_provider.resolve_runtime_provider",
                 return_value={
...
class TestFailureStreakNudge:
    ...
    def test_nudges_at_threshold(self):
        ...
        assert "max cron pause scout" in out
