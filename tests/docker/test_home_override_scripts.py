...
def test_dashboard_service_resets_home(
    ...
    container with MAX_DASHBOARD=1 and verify the dashboard process
...
def test_dashboard_does_not_auto_insecure_from_host(
    ...
    MAX_DASHBOARD_HOST. The auth gate is the authority now.
    ...
    """
    start_container(built_image, container_name, "MAX_DASHBOARD=1", "MAX_DASHBOARD_HOST=0.0.0.0")
