...
Only included in the max-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Max-Agent (https://github.com/StardustResearch/max-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_max_home() / "cache" / "discord_capabilities.json"
