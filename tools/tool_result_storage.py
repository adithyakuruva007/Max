...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/max-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/max-results/{tool_use_id}.txt on Termux)
