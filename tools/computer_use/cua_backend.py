...
_CUA_DRIVER_CMD = os.environ.get("MAX_CUA_DRIVER_CMD", "cua-driver")
...
def _resolve_mcp_invocation(
    ...
    *,
    ...
    Surface 8 of StardustResearch/max-agent#47072: instead of hardcoding
...
def cua_driver_binary_available() -> bool:
    """True if `cua-driver` is on $PATH or MAX_CUA_DRIVER_CMD resolves."""
...
def _parse_elements_from_structured(raw_elements: List[Dict[str, Any]]) -> List[UIElement]:
    """Surface 2 of StardustResearch/max-agent#47072: read the canonical
...
class _CuaDriverSession:
    ...
    def __init__(self, bridge: _AsyncBridge) -> None:
        ...
        self._started = False
        # Surface 4 of StardustResearch/max-agent#47072: per-tool
...
def _extract_tool_result(mcp_result: Any) -> Dict[str, Any]:
    ...
    StardustResearch/max-agent#47072). Each entry corresponds index-for-index
...
class CuaDriverBackend(ComputerUseBackend):
    ...
    def __init__(self) -> None:
        ...
        # Surface 6 of StardustResearch/max-agent#47072: per-snapshot
        ...
        #     concurrent Max runs / subagents don't step on each
        #     other.
        # We mint a UUID4-based id once per CuaDriverBackend instance —
        # one Max run = one backend = one session — and pass it as
        ...
        self._session_id: str = f"max-{uuid.uuid4().hex[:12]}"
    ...
    def capture(self, mode: str = "som", app: Optional[str] = None) -> CaptureResult:
        ...
        # Surface 3 of StardustResearch/max-agent#47072: read the canonical
        ...
        if mode == "vision":
            ...
            # Surface 2 of StardustResearch/max-agent#47072: prefer the
    ...
    def click(
        ...
        *,
        ...
        # StardustResearch/max-agent#47072). cua-driver-rs gained an explicit
