...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.(?:max|hermes)/\.env|\~/\.(?:max|hermes)/\.env',
     "max_env_access", "critical", "exfiltration",
    ...
    (r'\.(?:max|hermes)/config\.yaml|\.(?:max|hermes)/SOUL\.md',
     "max_config_mod", "critical", "persistence",
     "references Max configuration files directly"),
