...
from tools.xai_http import max_xai_user_agent
...
def _get_default_output_dir() -> str:
    ...
    return str(get_max_dir("cache/audio", "audio_cache"))
...
def _get_piper_voices_dir() -> Path:
    ...
    """
    from max_constants import get_max_dir
    root = Path(get_max_dir("cache/piper-voices", "piper_voices_cache"))
...
def text_to_speech_tool(
    ...
    Reads provider/voice config from ~/.max/config.yaml (tts: section).
            ...
            try:
                ...
                return json.dumps({
                    ...
                    "error": "Mistral provider selected but 'mistralai' package not installed. "
                             "Run: pip install 'max-agent[mistral]'"
                }, ensure_ascii=False)
