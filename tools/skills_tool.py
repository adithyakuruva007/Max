            ...
            return json.dumps(
                {
                    ...
                    "skills": [],
                    "categories": [],
                    "message": f"No skills found. Skills directory created at {display_max_home()}/skills/",
                },
                ensure_ascii=False,
            )
...
def skill_view(
    ...
    try:
        ...
        if isinstance(metadata, dict):
            max_meta = metadata.get("max", {}) or {}

        tags = _parse_tags(max_meta.get("tags") or frontmatter.get("tags", ""))
        related_skills = _parse_tags(
            max_meta.get("related_skills") or frontmatter.get("related_skills", "")
        )
