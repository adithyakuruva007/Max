...
def _make_max_provider_class() -> Optional[type]:
    ...
    class MaxMCPOAuthProvider(OAuthClientProvider):
        ...
        def __init__(
            ...
            **kwargs: Any,
            ...
            self._max_server_name = server_name
            ...
            self._max_preregistered = preregistered
                ...
                for url in build_oauth_authorization_server_metadata_discovery_urls(
                    ...
                    if asm:
                        ...
                        logger.debug(
                            ...
                            "token_endpoint=%s",
                            self._max_server_name, asm.token_endpoint,
                        )
                        break
...
_MAX_PROVIDER_CLS: Optional[type] = _make_max_provider_class()
