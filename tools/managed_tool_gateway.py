...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "stardustresearch.com"
...
def auth_json_path():
    """Return the Max auth store path, respecting MAX_HOME overrides."""
    return get_max_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`max tools`, banner/status paint, provider
...
# managed vendor's gateway URL is pinned: adding one is a Max release, and
