...
> **Nota:** En Windows nativo, Max funciona sin WSL — la CLI, el gateway, la TUI y las herramientas funcionan de forma nativa. Si prefieres usar WSL2, el comando de Linux/macOS de arriba también funciona allí. ¿Encontraste un error? Por favor [crea un issue](https://github.com/NousResearch/max-agent/issues).
...
Inicio rápido para colaboradores — clona y comienza con `setup-max.sh`:
...
Creado por [Stardust Research](https://stardustresearch.com).
