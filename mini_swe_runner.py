#!/usr/bin/env python3
"""
SWE Runner with Max Trajectory Format

A runner that uses Max-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Max-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Max-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Max format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Max-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Max-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Max Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Max-Agent's built-in execution environments
    and outputs trajectories in Max-Agent format.
    """
    ...
    def _convert_to_max_format(
        ...
        """
        Convert internal message format to Max trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Max trajectory format
        trajectory = self._convert_to_max_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Max trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Max Trajectory Format")
    print("=" * 60)
