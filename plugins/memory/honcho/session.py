...
class HonchoSessionManager:
    ...
    Runs alongside Max's existing SQLite state and file-based memory,
    ...
    def get_or_create(self, key: str) -> HonchoSession:
        ...
        assistant_peer_id = self._sanitize_id(
            self._config.ai_peer if self._config else "max-assistant"
        )
    ...
    def dialectic_query(
        ...
        try:
            ...
            # Apply Max-side char cap before caching
