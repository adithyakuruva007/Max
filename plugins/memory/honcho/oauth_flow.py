...
# The loopback redirect registered for the Max OAuth client. IP-literal so
...
def begin_authorization(
    ...
    *,
    ...
    (``max-desktop`` / ``max-cli``) so the consent side can attribute
...
_CALLBACK_HTML = (
    ...
    b"<div>Connected to Honcho. You can close this tab and return to Max.</div>"
)
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local MAX_HOME override can't reach.
