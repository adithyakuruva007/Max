...
def resolve_active_host() -> str:
    ...
    Resolution order:
      ...
      3. Fallback: ``"max"`` (default profile)
    """
...
def resolve_config_path() -> Path:
    ...
    default_path = _get_default_max_home() / "honcho.json"
...
class HonchoClientConfig:
    ...
    # Max chars of dialectic result to inject into Max system prompt
...
def get_honcho_client(config: HonchoClientConfig | None = None) -> Honcho:
    ...
    def _build() -> "Honcho":
        ...
        # the "go run max honcho setup" hint they used to.
        try:
