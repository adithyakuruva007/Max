# Max Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.max/plugins/max-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.max/plugins/max-achievements/scan_checkpoint.json`.
