...
# When the user hasn't picked a reasoning effort, Max passes
...
# ON at this effort — matching the "medium (default)" that Max' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Max' effort vocabulary onto Solar's accepted set via the
