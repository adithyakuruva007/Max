...
required — uses aiohttp which is already a Max dependency.
...
def interactive_setup() -> None:
    ...
    ``max_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Max delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # max_cli/setup.py::_setup_mattermost function.
