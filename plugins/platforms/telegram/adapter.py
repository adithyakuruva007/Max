...
# trigger its own recovery path. Refs: StardustResearch/max-agent#59614
...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_polling_network_error(self, error: Exception) -> None:
        ...
        try:
            if app and app.updater and app.updater.running:
                try:
                    ...
                    # Refs: StardustResearch/max-agent#58270
        ...
        try:
            ...
            # Refs: StardustResearch/max-agent#59614
            try:
                await asyncio.wait_for(
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            disable_fallback = (os.getenv("MAX_TELEGRAM_DISABLE_FALLBACK_IPS", "").strip().lower() in {"1", "true", "yes", "on"})
    ...
    def _message_mentions_bot(self, message: Message) -> bool:
        ...
        # raw substring matches like "foo@max_bot.example" are not mentions
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'max-agent[telegram]'",
