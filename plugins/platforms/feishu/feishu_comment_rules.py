...
Config: ~/.max/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.max/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_max_home()`` helper (MAX_HOME-aware and
...
RULES_FILE = get_max_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_max_home() / "feishu_comment_pairing.json"
