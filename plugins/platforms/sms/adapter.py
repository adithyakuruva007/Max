...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Max gateway adapter.

    Each inbound phone number gets its own Max session (multi-tenant).
...
# static dict in max_cli/gateway.py, and the _send_sms dispatch in
