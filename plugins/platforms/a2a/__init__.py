"""
A2A (Agent-to-Agent) plugin for Max Agent.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Max as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`max gateway setup` flow for A2A."""
    ...
    print_info("Expose Max as an A2A-discoverable agent and call other A2A agents.")
