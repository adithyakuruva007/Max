...
import type { ScrollBoxHandle } from '@max/ink'
import { evictInkCaches } from '@max/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = dualEnv('TUI_ACTIVE_SESSION_FILE')) => {
  if (!file || !sessionId) {
    return
  }
