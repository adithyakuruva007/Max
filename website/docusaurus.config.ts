...
const config: Config = {
  ...
  url: 'https://max-agent.stardustresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'max-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/max-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/max-agent-banner.png',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://max-agent.stardustresearch.com/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/NousResearch/max-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/NousResearch/max-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://max-agent.stardustresearch.com/' },
            { label: 'GitHub', href: 'https://github.com/NousResearch/max-agent' },
            { label: 'Stardust Research', href: 'https://stardustresearch.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://stardustresearch.com">Stardust Research</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
