...
```bash
max acp                  # serve ACP on stdio
max acp --bootstrap      # print install snippet for an ACP-capable IDE
```
...
- **API server:** include a `model` field in the request body or set `X-max-Model`
