...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `max_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `max_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Max Plugin](plugins/index.md) |
...
| Session storage | `max_state.py` | [Session Storage](session-storage.md) |
