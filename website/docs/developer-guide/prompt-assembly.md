...
You are Max, an AI assistant created by Nous Research.
...
```
You are Max Agent, an intelligent AI assistant created by Nous Research.
...
def build_context_files_prompt(cwd=None, skip_soul=False):
    ...
    project_context = (
        _load_hermes_md(cwd_path)       # 1. .max.md / Max.md (walks to git root)
...
|----------|-------|-------------|-------|
| 1 | `.max.md`, `max.md` | CWD up to git root | max-native project config |
...
1. `.max.md` / `max.md` (walks to git root)
...
- Project context files such as `.max.md`, `max.md`, `AGENTS.md`, `CLAUDE.md`, or `.cursorrules` — inject repo-specific working rules.
