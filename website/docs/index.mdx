...
slug: /
sidebar_position: 0
title: "Max Agent Documentation"
description: "The self-improving AI agent built by Stardust Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Stardust Research](https://stardustresearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `max setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Max safely  |
| 🧭 **[Use MCP with Max](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Max](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Max voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Max' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Max                              |
...
- **Built by model trainers** — Created by [Stardust Research](https://stardustresearch.com), the lab behind Max, Nomos, and Psyche. Works with [Nous Portal](https://portal.stardustresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Stardust Research](https://stardustresearch.com) — the lab behind Max, Nomos, and Psyche models
