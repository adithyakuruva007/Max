...
description: "How the Max Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Max Desktop app connects to a **gated gateway** (a hosted or
...
For Max specifically, native sign-in means:
...
- [Run Max with Nous Portal](./run-hermes-with-nous-portal.md)
