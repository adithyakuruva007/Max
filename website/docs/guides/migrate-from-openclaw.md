...
max claw migrate --preset full --migrate-secrets --yes
```
...
5. **Test messaging** — if you migrated platform tokens, restart the gateway: `systemctl --user restart max-gateway`
