...
For a full guide, see [Use SOUL.md with Max](/guides/use-soul-with-hermes).
...
| What | Location |
|------|----------|
| Gateway logs | `journalctl --user -u hermes-gateway` (Linux) or `~/.max/logs/gateway.log` (macOS) |
