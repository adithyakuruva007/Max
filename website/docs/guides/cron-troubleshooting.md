...
Skill names are case-sensitive and must match the installed skill's folder name. If your job specifies `ai-funding-daily-report` but the skill folder is `ai-funding-daily-report`, confirm the exact name from `max skills list`.
...
3. Open an issue at [github.com/NousResearch/max-agent](https://github.com/NousResearch/hermes-agent) with:
