...
| [`max-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-max-agent) | Use, configure, theme, extend, and orchestrate Max Agent. | `autonomous-ai-agents/max-agent` |
...
| [`max-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-max-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/max-agent-skill-authoring` |
| [`inspecting-hermes-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-hermes-desktop-dom) | Read the live Max desktop DOM/CSS over CDP. | `software-development/inspecting-hermes-desktop-dom` |
