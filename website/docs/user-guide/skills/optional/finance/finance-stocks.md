...
| | |
|---|---|
| Source | Optional — install with `max skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), max Agent |
| License | MIT |
...
```
SCRIPT=~/.max/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.max/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
