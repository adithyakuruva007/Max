---
title: "Honcho — Configure and troubleshoot Honcho memory for Max"
sidebar_label: "Honcho"
description: "Configure and troubleshoot Honcho memory for Max"
---
...
Configure and troubleshoot Honcho memory for Max.
...
Config file: `$MAX_HOME/honcho.json` (profile-local) or `~/.honcho/config.json` (global).
