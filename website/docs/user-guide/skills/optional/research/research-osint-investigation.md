...
| | |
|---|---|
| Source | Optional — install with `max skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Max Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $MAX_OSINT_CACHE/icij/ (default: ~/.cache/hermes-osint/icij/).
...
# Set MAX_OSINT_UA=your-app/1.0 (your@email) to identify yourself
