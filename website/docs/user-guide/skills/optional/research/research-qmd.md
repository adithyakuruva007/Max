...
| | |
|---|---|
| Source | Optional — install with `max skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`max-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-max-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Max Agent via the native MCP client. This is the preferred
...
Then configure Max Agent to connect via HTTP:
