...
| | |
|---|---|
| Source | Optional — install with `max skills install official/research/gitnexus-explorer` |
...
| Related skills | [`max-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-max-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
