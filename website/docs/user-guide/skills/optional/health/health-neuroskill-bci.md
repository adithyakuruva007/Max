...
| | |
|---|---|
| Source | Optional — install with `max skills install official/health/neuroskill-bci` |
...
Connect Max to a running [NeuroSkill](https://neuroskill.com/) instance to read
