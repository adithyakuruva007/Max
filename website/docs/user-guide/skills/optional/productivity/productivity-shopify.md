...
| | |
|---|---|
| Source | Optional — install with `max skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"max","productType":"Apparel","tags":["test"]}}'
```
