...
| | |
|---|---|
| Source | Optional — install with `max skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing max tool access (web_search, file ops). Stateless. |
