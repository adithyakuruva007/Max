...
| OpenAI Codex | `openai-codex` | `max model` (ChatGPT OAuth) |
...
| Qwen Portal (OAuth) | `qwen-oauth` | `max model` (Qwen Portal OAuth; optional: `HERMES_QWEN_BASE_URL`) |
...
| `"codex"` | Force Codex OAuth | `max model` → Codex |
