...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/use-mcp-with-max", "Use MCP with Max", None),
        ("guides/use-voice-mode-with-max", "Use Voice Mode with Max", None),
        ("guides/use-soul-with-max", "Use SOUL.md with Max", None),
        ("guides/build-a-max-plugin", "Build a Max Plugin", None),
