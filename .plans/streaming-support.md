# Streaming LLM Response Support for Max Agent
...
```
MAX_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("MAX_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `max_cli/config.py` | 1 | +streaming config defaults |
