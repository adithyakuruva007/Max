...
import { Select, SelectOption } from "@stardust-research/ui/ui/components/select";
...
import { ConfirmDialog } from "@stardust-research/ui/ui/components/confirm-dialog";
...
export default function SystemPage() {
  ...
  // spawned `max import` runs non-interactively (stdin is /dev/null), so
  ...
  const canUpdateMax = status?.can_update_hermes !== false;
            ...
            <div className="flex flex-col gap-3 border-t border-border pt-4 sm:flex-row sm:items-end">
              <div className="grid min-w-0 flex-1 gap-2">
                ...
                <Input
                  ...
                  placeholder="$MAX_HOME/backups/hermes-backup.zip"
                />
              </div>
              <Button
                size="sm"
