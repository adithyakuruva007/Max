 ...
 *
 * Values mirror max_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Max default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Max' default when unset). */
