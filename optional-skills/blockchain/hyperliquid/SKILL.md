...
```bash
python ~/.max/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.max/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.max/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
