...
python ~/.max/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.max/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.max/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.max/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.max/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.max/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
