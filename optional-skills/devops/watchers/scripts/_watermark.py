...
def _state_dir() -> Path:
    ...
    # Default: $MAX_HOME/watcher-state/, falling back to ~/.max/watcher-state/.
    max_home = os.environ.get("MAX_HOME") or str(Path.home() / ".hermes")
    return Path(max_home) / "watcher-state"
