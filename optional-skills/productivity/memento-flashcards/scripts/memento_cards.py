...
Data file: $MAX_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_MAX_HOME = Path(os.environ.get("MAX_HOME", Path.home() / ".hermes"))
DATA_DIR = _MAX_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
