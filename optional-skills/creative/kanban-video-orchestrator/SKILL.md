...
metadata:
  hermes:
    ...
    credits: |
      ...
      https://github.com/StardustResearch/kanban-video-pipeline.
---
...
3. Creates each Max profile via `hermes profile create --clone`
