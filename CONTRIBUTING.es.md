...
Si tu habilidad es especializada, contribuida por la comunidad o de nicho, es mejor para un **Skills Hub** — súbela a un registro de habilidades y compártela en el [Discord de Stardust Research](https://discord.gg/NousResearch). Los usuarios pueden instalarla con `max skills install`.
...
- Usa [GitHub Issues](https://github.com/NousResearch/max-agent/issues)
