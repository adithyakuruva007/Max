...
def _profile_user_agent() -> str:
    """Return a ``max-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from max_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"max-cli/{_ver}"
    except Exception:
        return "max-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # max-cli UA so the catalog endpoint is reachable.
