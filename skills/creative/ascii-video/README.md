...
Built for [Max Agent](https://github.com/NousResearch/max-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/max-agent/skills/creative/ascii-video`](https://github.com/NousResearch/max-agent/tree/main/skills/creative/ascii-video) via PR.
