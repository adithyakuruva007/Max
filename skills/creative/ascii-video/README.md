...
Built for [Max Agent](https://github.com/StardustResearch/max-agent). Usable in any coding agent. Canonical source lives here; synced to [`StardustResearch/max-agent/skills/creative/ascii-video`](https://github.com/StardustResearch/max-agent/tree/main/skills/creative/ascii-video) via PR.
