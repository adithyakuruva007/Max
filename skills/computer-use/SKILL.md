...
for the platform plumbing. The Max-side `computer_use` tool exposed
in this skill is a higher-level Max vocabulary; the raw cua-driver
...
When `cua-driver skills install` autodetects Max (planned follow-up
