...
def _(rid, params: dict) -> dict:
    from max_cli.input_sanitize import sanitize_user_prompt_text
    ...
    # over another app when they are back in Max.
        ...
        if (
            ...
            if not is_truthy_value(params.get("confirm_truncate")):
                ...
                return _err(
                    ...
                    "(update your Max client if a rewind was intended)",
                )
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            # MAX_HOME override (the ContextVar set on the session-create
            ...
            home_token = (
                set_max_home_override(_profile_home_str)
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            # the session's MAX_HOME override (the ContextVar set on the
...
def _(rid, params: dict) -> dict:
    # `text` is a JSON string describing the OS window underneath the Max
