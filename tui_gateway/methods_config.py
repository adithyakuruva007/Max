    ...
    try:
        with _profile_db(params) as db:
            ...
            with pdb.connect_closing() as conn:
                ...
                # zero Max sessions still surface. The desktop's native scan
...
def _(rid, params: dict) -> dict:
    ...
    if key == "profile":
        ...
        return _ok(rid, {"home": str(_hermes_home), "display": display_max_home()})
    if key == "project":
...
def _(rid, params: dict) -> dict:
    ...
    collection + force-redaction pipeline as ``max debug share --nous``
