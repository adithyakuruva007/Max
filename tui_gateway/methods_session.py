...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        # atexit.register(_drain_token_queue_at_exit) (max_state.py), which only
...
def _(rid, params: dict) -> dict:
    ...
    from max_cli.nous_billing import BillingError, post_subscription_preview
...
def _(rid, params: dict) -> dict:
    ...
    billing:manage.
    """
    from max_cli.nous_billing import BillingError, put_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    """
    from max_cli.nous_billing import BillingError, delete_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    from max_cli.nous_billing import BillingError, post_subscription_upgrade
...
def _(rid, params: dict) -> dict:
    ...
    """
    from max_cli.nous_billing import BillingError, post_charge
    from agent.billing_view import new_idempotency_key
...
def _(rid, params: dict) -> dict:
    ...
    """
    from max_cli.nous_billing import BillingError, get_charge_status
...
def _(rid, params: dict) -> dict:
    ...
    """
    from max_cli.nous_billing import BillingError, patch_auto_top_up
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from max_cli.nous_billing import BillingError
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        if parent_home:
            ...
            branch_owns_db = True
        home_token = (
            set_max_home_override(parent_home) if parent_home else None
        )
