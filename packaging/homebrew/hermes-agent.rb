class HermesAgent < Formula
  ...
  homepage "https://hermes-agent.stardustresearch.com"
  # Stable source should point at the semver-named sdist asset attached by
  # scripts/release.py, not the CalVer tag tarball.
  url "https://github.com/StardustResearch/hermes-agent/releases/download/v2026.3.30/hermes_agent-0.6.0.tar.gz"
