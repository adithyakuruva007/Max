# nix/web.nix — Max Web Dashboard (Vite/React) frontend build
{ pkgs, maxNpmLib, ... }:
let
  npm = maxNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "max-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../max_cli/web_dist for the
