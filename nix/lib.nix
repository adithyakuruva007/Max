      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via MAX_BUNDLED_SKILLS /
            # MAX_OPTIONAL_SKILLS (see max-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + MAX_BUNDLED_LOCALES
            # / MAX_OPTIONAL_MCPS, not via the wheel. Excluding them
