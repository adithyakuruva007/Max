...
_loaded_env_paths = load_max_dotenv(max_home=_max_home, project_env=_project_env)
...
class AIAgent:
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        """
        Preload the LM Studio model with at least Max' minimum context.
        """
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        # ``monkeypatch.setattr("max_cli.plugins.has_hook", ...)`` still
        ...
        try:
            from max_cli import plugins as _plugins
    ...
    def _build_keepalive_http_client(base_url: str = "", *, verify: Any = True) -> Any:
        ...
        ``MAX_CA_BUNDLE`` settings.  It is passed on the client AND on
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from max_cli.copilot_auth import resolve_copilot_token
