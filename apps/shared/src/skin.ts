/**
 * Canonical Max skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$MAX_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`max_cli/skin_engine.py`),
 ...
 *   • CLI     → `max_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
