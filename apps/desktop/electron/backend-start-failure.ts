 ...
 * startMax() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startMax() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startMax`, re-emits
