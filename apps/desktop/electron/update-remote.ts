 ...
 *
 * A public install can end up with `origin=git@github.com:StardustResearch/max-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/StardustResearch/max-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/stardustresearch/hermes-agent'
