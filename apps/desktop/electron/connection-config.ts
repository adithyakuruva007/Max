...
//   - max_session_at: the OAuth access token. Short-lived (~15 min); its
//     Max-Age tracks the access-token TTL, so the cookie jar drops it the
//     instant the AT expires.
//   - max_session_rt: the OAuth refresh token. Long-lived (24h rotating,
...
const AT_COOKIE_VARIANTS = ['__Host-max_session_at', '__Secure-max_session_at', 'max_session_at']
const RT_COOKIE_VARIANTS = ['__Host-max_session_rt', '__Secure-max_session_rt', 'max_session_rt']
