...
// even though a fresh shell — and the Max CLI — sees it immediately. The
// desktop's MAX_HOME resolution relies on process.env, so that stale-snapshot
