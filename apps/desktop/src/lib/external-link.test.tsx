...
const desktopWindow = window as unknown as { maxDesktop?: Window['maxDesktop'] }
const initialMaxDesktop = desktopWindow.maxDesktop

function installDesktopBridge(partial: Partial<Window['maxDesktop']> = {}) {
  desktopWindow.maxDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['maxDesktop']
}
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['maxDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['maxDesktop']['openExternal'] })
