...
//
// When someone is in a hands-free "Hey Max" voice chat, the natural way to
...
// phrase (optionally addressed to Max), so a real turn that merely contains
...
// Optional address prefixes so "max stop" / "ok stop" / "hey hermes, stop"
 ...
 * to Max). Returns false for anything that merely contains "stop" as part of
