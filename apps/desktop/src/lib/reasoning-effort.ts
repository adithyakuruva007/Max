...
/** Max' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (max_constants.py). `none` is not a level: it's
...
/** Max' built-in level when neither the surface nor the profile config
