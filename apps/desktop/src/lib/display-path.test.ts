...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/max-agent')).toBe('~/www/max-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/max-agent')).toBe('max-agent')
    expect(pathLeaf('~/www/max-agent')).toBe('max-agent')
