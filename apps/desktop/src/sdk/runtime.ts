...
const GLOBALS = {
  __MAX_PLUGIN_SDK__: sdk,
  __MAX_REACT__: React,
  __MAX_REACT_JSX__: jsxRuntime,
  __MAX_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@hermes/plugin-sdk': shimUrl('__MAX_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__MAX_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__MAX_REACT_JSX__'),
    react: shimUrl('__MAX_REACT__')
  }
