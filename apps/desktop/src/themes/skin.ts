/**
 * Max skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$MAX_HOME/skins/` (or a
 * built-in) resolved by `max_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Max authors from a prompt lights up all three surfaces from one file.
 *
...
import type { MaxSkin, SkinColors } from '@hermes/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: MaxSkin): DesktopTheme | null {
