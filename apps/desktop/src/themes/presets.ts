...
/**
 * Nous — the canonical Max desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Max's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Max desktop identity: GitHub's chrome carrying Nous
