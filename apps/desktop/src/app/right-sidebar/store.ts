...
const TAKEOVER_KEY = 'max.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Max can't clear via the API — the user
 *  sees exactly what runs instead of Max silently deleting their creds. */
