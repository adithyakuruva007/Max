import { isGatewayReauthRequired, resolveGatewayWsUrl } from '@max/shared'
import { useEffect, useRef } from 'react'

import type { MaxConnection } from '@/global'
import { MaxGateway } from '@/max'
...
import type { RpcEvent } from '@/types/max'
  ...
  useEffect(() => {
    ...
    async function boot() {
      try {
        ...
        await callbacksRef.current.refreshMaxConfig()
