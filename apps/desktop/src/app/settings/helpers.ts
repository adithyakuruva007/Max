...
import type { ConfigFieldSchema, MaxConfigRecord, ToolsetInfo } from '@/types/hermes'
...
export function getNested(obj: MaxConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: MaxConfigRecord, next: MaxConfigRecord): boolean {
...
export function voiceFieldVisible(key: string, config: MaxConfigRecord): boolean {
...
export function setNested(obj: MaxConfigRecord, path: string, value: unknown): MaxConfigRecord {
...
function personalityOptions(config: MaxConfigRecord): string[] {
...
function commandProviderNames(config: MaxConfigRecord, section: 'tts' | 'stt'): string[] {
