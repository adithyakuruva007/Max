...
import { getElevenLabsVoices, getMaxConfigSchema, saveMaxConfig } from '@/max'
import { useI18n } from '@/i18n'
import { cn } from '@/lib/utils'
import { notify, notifyError } from '@/store/notifications'
import type { ConfigFieldSchema, MaxConfigRecord } from '@/types/max'

import { setMaxConfigCache, useMaxConfigRecord } from '../hooks/use-config-record'
...
export function ConfigSettings({
  ...
  const [config, setConfig] = useState<MaxConfigRecord | null>(null)
  const { data: loadedConfig, isError: configLoadFailed, refetch: refetchConfig } = useMaxConfigRecord()
  ...
  const updateConfig = (next: MaxConfigRecord) => {
