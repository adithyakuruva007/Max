...
import { getMaxConfigRecord, listAllProfileSessions } from '@/max'
...
// Max session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-max',
            keywords: ['update', 'upgrade', 'max', 'version', 'system', 'restart'],
            label: cc.updateMax,
