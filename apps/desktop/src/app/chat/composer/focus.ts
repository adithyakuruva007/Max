...
const FOCUS_EVENT = 'max:composer-focus'
const INSERT_EVENT = 'max:composer-insert'
const INSERT_REFS_EVENT = 'max:composer-insert-refs'
const SUBMIT_EVENT = 'max:composer-submit'
const VOICE_TOGGLE_EVENT = 'max:composer-voice-toggle'
