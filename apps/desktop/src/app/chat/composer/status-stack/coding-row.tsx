...
const branchActionLabel = (branch: MaxGitBranch, copy: BranchActionCopy) => {
...
interface CodingStatusRowProps {
  ...
  onListBranches?: () => Promise<MaxGitBranch[]>
...
export const CodingStatusRow = memo(function CodingStatusRow({
  ...
  const [branches, setBranches] = useState<MaxGitBranch[]>([])
  ...
  const convertBranch = async (branch: MaxGitBranch) => {
