...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/max'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('max:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('max:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
