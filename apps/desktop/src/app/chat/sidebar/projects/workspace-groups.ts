...
import type { ProjectInfo, SessionInfo } from '@/max'
 ...
 * repo shows its branches/worktrees even when they have no Max sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: MaxGitWorktree[]
): SidebarSessionGroup[] {
