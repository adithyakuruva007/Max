...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Max Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Max backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      remoteDesc:
        'Connect this desktop shell to a remote Max backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /max.',
      ...
      restartingMessage: 'Max Desktop will reconnect using the saved settings.',
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@max:example.org' },
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Max inference gateway status',
      agents: 'Agents',
