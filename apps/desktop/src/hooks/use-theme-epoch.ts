...
// props/data-max-* on <html>. Canvas/probe consumers that rasterize the
...
const ATTRS = ['class', 'style', 'data-max-mode', 'data-max-theme', 'data-hermes-mode', 'data-hermes-theme']
