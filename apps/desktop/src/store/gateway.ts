import { type ConnectionState, type GatewayEvent, resolveGatewayWsUrl } from '@max/shared'
...
export const $gateway = atom<MaxGateway | null>(null)
...
let primaryGateway: MaxGateway | null = null
