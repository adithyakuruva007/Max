...
const STORAGE_KEY = 'max:native-notifications'
const STORAGE_KEY_OLD = 'hermes:native-notifications'
...
function readPrefs(): NativeNotificationPrefs {
  const raw = storedString(STORAGE_KEY) || storedString(STORAGE_KEY_OLD)
