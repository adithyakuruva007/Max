...
import type { MaxBranchPullRequest } from '@/global'
...
export const $pullRequestsByBranch = atom<Record<string, MaxBranchPullRequest>>({})
...
export function pullRequestBucket(pr: MaxBranchPullRequest | undefined): PullRequestBucket {
  if (!pr) {
    return 'none'
  }
