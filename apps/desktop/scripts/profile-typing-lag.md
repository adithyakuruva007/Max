...
cd apps/desktop
XCURSOR_SIZE=24 MAX_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/max-typing
# → /tmp/max-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/max-typing.before.heapsnapshot
# → /tmp/max-typing.after.heapsnapshot
```
