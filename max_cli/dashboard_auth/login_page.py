...
Visual styling mirrors the Stardust Research design system (the
``@stardust-research/ui`` package the React dashboard uses): the same
...
``tests/max_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Max Agent</title>
<style>
  /* Brand fonts shipped by @stardust-research/ui — same files the SPA loads. */
  @font-face {{
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Max Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Max Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
See the <a href="https://max-agent.stardustresearch.com/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
