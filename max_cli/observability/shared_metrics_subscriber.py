"""Relay subscriber for the persisted Max shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Max counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Max shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
