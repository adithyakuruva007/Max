"""Durable aggregation and local export for Max shared metrics."""
...
from max_cli.sqlite_util import write_txn
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_max_home() / "telemetry" / "shared_metrics"
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Max processes.
            with write_txn(connection):
