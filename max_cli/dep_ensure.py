...
def _has_max_agent_browser() -> bool:
    ...
    # install.sh installs globally into $MAX_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-MaxHome", str(get_max_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = max_subprocess_env(inherit_credentials=False)
