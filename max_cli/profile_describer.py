...
Used by ``max profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``max_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Max Agent kanban board.
...
Rules:
  ...
  - Never write "Max Agent profile" or other meta-narration.
