...
class CLICommandsMixin:
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if not session_meta:
            ...
            _cprint("  Use /history or `max sessions list` to see available sessions.")
            return
    ...
    def _compose_in_editor(self, initial_text: str = "") -> str:
        ...
        fd, path = tempfile.mkstemp(suffix=".md", prefix="max_prompt_")
        try:
    ...
    def _handle_busy_command(self, cmd: str):
        ...
        if save_config_value("display.busy_input_mode", arg):
            if arg == "queue":
                ...
                behavior = "Enter will interrupt the current run while Max is busy."
