"""Max middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "max.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "max.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before Max sends them.
    """
