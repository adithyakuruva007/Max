...
Entry point: ``max whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``max_cli/main.py``).
...
Max gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Max to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Max needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Max gateway in another terminal:")
    print("         max gateway")
    print()
    ...
    print()
    print("  Docs: https://max-agent.stardustresearch.com/docs/user-guide/")
