...
def _split_line(line: str) -> list[str]:
    try:
        ...
        from max_cli._subprocess_compat import split_command_line
...
class MaxConsoleEngine:
    ...
    def _register_defaults(self) -> None:
        self.register(("status",), "status", "Show Max component status.", _status)
        self.register(("version",), "version", "Show Max version information.", _version)
        self.register(("doctor",), "doctor", "Run diagnostics without auto-fix.", _doctor)
        self.register(("logs",), "logs [name] [-n N]", "Show recent Max logs.", _logs)
...
def _version(_engine: MaxConsoleEngine, args: list[str]) -> str:
    _expect_no_args(args, "version")
    from max_cli._startup_fast import print_fast_version_info
