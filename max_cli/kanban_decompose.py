...
Invoked by ``max kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Max Agent board.
...
def _profile_author() -> str:
    """Mirror of ``max_cli.kanban._profile_author``."""
    return (
