...
TIPS = [
    ...
    "max chat --max-turns 1000 overrides the default 500-iteration limit per turn.",
    ...
    "/plan writes a markdown implementation plan to .max/plans/ without executing anything.",
    ...
    'MAX_BACKGROUND_NOTIFICATIONS=result only pings when background tasks finish (vs concise/all/error/off).',
    ...
    'max import restores a full Max backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
...
# any project or none — Max is not a coding-only agent.
# ---------------------------------------------------------------------------
