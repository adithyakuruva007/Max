...
def _build_hermes_tools_mcp_entry() -> dict:
    ...
    hermes_home = os.environ.get("MAX_HOME") or ""
    if hermes_home and _looks_like_test_tempdir(hermes_home):
        hermes_home = ""
    if hermes_home:
        env["MAX_HOME"] = hermes_home
...
def migrate(
    ...
    *,
    ...
    Args:
        hermes_config: full ~/.max/config.yaml dict
        ...
        expose_hermes_tools: when True (default), register Max' own
